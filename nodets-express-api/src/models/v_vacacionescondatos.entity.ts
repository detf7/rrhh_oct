...
//2lines
@Entity({ name: 'v_vacacionescondatos', schema: 'public' })
export default class V_Vacacionescondatos extends BaseModel {
	static getQuery(){
		return this.createQueryBuilder("v_vacacionescondatos");
	}
