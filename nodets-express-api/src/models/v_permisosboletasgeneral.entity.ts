...
//2lines
@Entity({ name: 'v_permisosboletasgeneral', schema: 'public' })
export default class V_Permisosboletasgeneral extends BaseModel {
	static getQuery(){
		return this.createQueryBuilder("v_permisosboletasgeneral");
	}
