...
//2lines
@Entity({ name: 'v_vacacionessindatos', schema: 'public' })
export default class V_Vacacionessindatos extends BaseModel {
	static getQuery(){
		return this.createQueryBuilder("v_vacacionessindatos");
	}
