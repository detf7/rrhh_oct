                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/v_permanente"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.VPermanenteListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                        ...
                                        <q-td  key="fnacimiento" :props="props">
                                            {{ props.row.fnacimiento }}
                                        </q-td>
                                        ...
                                        <q-td  key="fotografia" :props="props">
                                            {{ props.row.fotografia }}
                                        </q-td>
...
<script setup>
	...
	const props = defineProps({
		...
		pageName : {
			type : String,
			default : 'v_permanente',
		},
		routeName : {
			type : String,
			default : 'v_permanentelist',
		},
		apiPath : {
			type : String,
			default : 'v_permanente/index',
		},
		paginate: {
			type: Boolean,
			default: true,
