                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/v_reppedidos"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.VReppedidosListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                        ...
                                        <q-td  key="nombreyap" :props="props">
                                            {{ props.row.nombreyap }}
                                        </q-td>
...
<script setup>
	...
	const props = defineProps({
		...
		pageName : {
			type : String,
			default : 'v_reppedidos',
		},
		routeName : {
			type : String,
			default : 'v_reppedidoslist',
		},
		apiPath : {
			type : String,
			default : 'v_reppedidos/index',
		},
		paginate: {
			type: Boolean,
			default: true,
