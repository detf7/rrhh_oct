                        ...
                        <div  class="col comp-grid" >
                            <div >
                                <div class="q-mb-3 row q-col-gutter-md justify-start">
                                    ...
                                    <div class="col-12 col-md-4">
                                        <q-card  class="q-pa-md nice-shadow-16">
                                            <div class="row q-col-gutter-x-md items-center">
                                                <div class="col">
                                                    <div class="text-grey text-weight-medium mb-1">Montodia</div>
                                                    <div class="text-bold">{{ item.montodia }}</div>
                                                </div>
                                            </div>
                                        </q-card>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-4">
                                        <q-card  class="q-pa-md nice-shadow-16">
                                            <div class="row q-col-gutter-x-md items-center">
                                                <div class="col">
                                                    <div class="text-grey text-weight-medium mb-1">Boleta</div>
                                                    <div class="text-bold">{{ item.boleta }}</div>
                                                </div>
                                            </div>
                                        </q-card>
                                    </div>
                                    <div class="col-12 col-md-4">
                                        <q-card  class="q-pa-md nice-shadow-16">
                                            <div class="row q-col-gutter-x-md items-center">
                                                <div class="col">
                                                    <div class="text-grey text-weight-medium mb-1">Total</div>
                                                    <div class="text-bold">{{ item.total }}</div>
                                                </div>
                                            </div>
                                        </q-card>
                                    </div>
                                    <div class="col-12 col-md-4">
                                        <q-card  class="q-pa-md nice-shadow-16">
                                            <div class="row q-col-gutter-x-md items-center">
                                                <div class="col">
                                                    <div class="text-grey text-weight-medium mb-1">Idplarefri</div>
                                                    <div class="text-bold">{{ item.idplarefri }}</div>
                                                </div>
                                            </div>
                                        </q-card>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-4">
                                        <q-card  class="q-pa-md nice-shadow-16">
                                            <div class="row q-col-gutter-x-md items-center">
                                                <div class="col">
                                                    <div class="text-grey text-weight-medium mb-1">Diastrabajo</div>
                                                    <div class="text-bold">{{ item.diastrabajo }}</div>
                                                </div>
                                            </div>
                                        </q-card>
                                    </div>
                                ...
                                <div class="row q-col-gutter-xs justify-start q-ma-md">
                                    <div><q-btn icon="edit" label="Edit" glossy  flat :rounded="false"  no-caps  unelevated   padding="xs" color="positive" title="Editar"  @click="app.openPageDialog({ page:'plarefrigerio/edit', url: `/plarefrigerio/edit/${item.idplarefri}` , closeBtn: true })">
                                    </q-btn></div>
                                    <div><q-btn icon="delete_sweep" label="Delete" glossy  flat :rounded="false"  no-caps  unelevated   padding="xs" color="negative" title="Borrar"  @click="deleteItem(item.idplarefri)">
                                    </q-btn></div>
                                </div>
                            </div>
                        </div>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'plarefrigerioview',
		},
		apiPath: {
			type: String,
			default: 'plarefrigerio/view',
		},
		editButton: {
			type: Boolean,
			default: true,
