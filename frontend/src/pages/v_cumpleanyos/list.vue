                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/v_cumpleanyos"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.VCumpleanyosListHeaderItems" 
                                :rows="records"
...
<script setup>
	...
	const props = defineProps({
		...
		pageName : {
			type : String,
			default : 'v_cumpleanyos',
		},
		routeName : {
			type : String,
			default : 'v_cumpleanyoslist',
		},
		apiPath : {
			type : String,
			default : 'v_cumpleanyos/index',
		},
		paginate: {
			type: Boolean,
			default: true,
