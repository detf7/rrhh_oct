                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/v_temporalvacacion"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.VTemporalvacacionListHeaderItems" 
                                :rows="records"
...
<script setup>
	...
	const props = defineProps({
		...
		pageName : {
			type : String,
			default : 'v_temporalvacacion',
		},
		routeName : {
			type : String,
			default : 'v_temporalvacacionlist',
		},
		apiPath : {
			type : String,
			default : 'v_temporalvacacion/index',
		},
		paginate: {
			type: Boolean,
			default: true,
