                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/detallecompra/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/detallecompra"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.DetallecompraListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                        ...
                                        <q-td  key="iddetcompra" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/detallecompra/view/${props.row.iddetcompra}`">{{ props.row.iddetcompra }}</q-btn>
                                        </q-td>
                                        <q-td  key="cantidad" :props="props">
                                            {{ props.row.cantidad }}
                                        </q-td>
                                        <q-td  key="preciouni" :props="props">
                                            {{ props.row.preciouni }}
                                        </q-td>
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <q-item link clickable v-ripple :to="`/detallecompra/view/${props.row.iddetcompra}`">
                                                                <q-item-section>
                                                                    <q-icon color="primary" size="sm" name="visibility"></q-icon>
                                                                </q-item-section>
                                                                <q-item-section>View</q-item-section>
                                                            </q-item>
                                                            <q-item link clickable v-ripple :to="`/detallecompra/edit/${props.row.iddetcompra}`">
                                                                <q-item-section>
                                                                    <q-icon color="positive" size="sm" name="edit"></q-icon>
                                                                </q-item-section>
                                                                <q-item-section>Edit</q-item-section>
                                                            </q-item>
                                                            <q-item link clickable v-ripple @click="deleteItem(props.row.iddetcompra)">
                                                                <q-item-section>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'detallecompralist',
		},
		apiPath : {
			type : String,
			default : 'detallecompra/index',
		},
		paginate: {
			type: Boolean,
			default: true,
