                                    ...
                                    <div class="row q-col-gutter-x-md">
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <q-input   ref="ctrlpreciouni" v-model.trim="formData.preciouni"  label="Preciouni" type="number" placeholder="Escribir Preciouni"   step="0.1"    
                                                    class="" :error="isFieldValid('preciouni')" :error-message="getFieldError('preciouni')">
                                                    </q-input>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <api-data-source @loaded="response => mapOptionField(response, 'codcompra')"  api-path="components_data/codcompra_option_list"  v-slot="req">
                                                        <q-select    :loading="req.loading"   ref="ctrlcodcompra" emit-value map-options  v-model="formData.codcompra" :options="req.response" label="Codcompra"  :error="isFieldValid('codcompra')" :error-message="getFieldError('codcompra')">
                                                        </q-select> 
                                                    </api-data-source>
                                                </div>
                                            </div>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'detallecompraedit',
		},
		pagePath: {
			type : String,
			default : 'detallecompra/edit',
		},
		apiPath: {
			type: String,
			default: 'detallecompra/edit',
