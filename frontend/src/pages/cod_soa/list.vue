                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/cod_soa/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/cod_soa"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.CodSoaListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <q-item link clickable v-ripple :to="`/cod_soa/view/${props.row.id_soa}`">
                                                                <q-item-section>
                                                                    <q-icon color="primary" size="sm" name="visibility"></q-icon>
                                                                </q-item-section>
                                                                <q-item-section>View</q-item-section>
                                                            </q-item>
                                                            <q-item link clickable v-ripple :to="`/cod_soa/edit/${props.row.id_soa}`">
                                                                <q-item-section>
                                                                    <q-icon color="positive" size="sm" name="edit"></q-icon>
                                                                </q-item-section>
                                                                <q-item-section>Edit</q-item-section>
                                                            </q-item>
                                                            <q-item link clickable v-ripple @click="deleteItem(props.row.id_soa)">
                                                                <q-item-section>
                                        ...
                                        <q-td  key="id_soa" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/cod_soa/view/${props.row.id_soa}`">{{ props.row.id_soa }}</q-btn>
                                        </q-td>
                                        <q-td  key="nro_soa" :props="props">
                                            {{ props.row.nro_soa }}
                                        </q-td>
                                        <q-td  key="fecha_reg" :props="props">
                                            {{ props.row.fecha_reg }}
                                        </q-td>
                                        <q-td  key="nombre_soa" :props="props">
                                            {{ props.row.nombre_soa }}
                                        </q-td>
                                        <q-td  key="cod_gestion_soa" :props="props">
                                            {{ props.row.cod_gestion_soa }}
                                        </q-td>
                                    </q-tr>
                                </template>
                                <!-- End of Table Layout-->
