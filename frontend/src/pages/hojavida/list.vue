                                    ...
                                    <div >
                                        ...
                                        <template v-slot:body="props">
                                            <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                ...
                                                <q-td  key="idhoja" :props="props">
                                                    <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/hojavida/view/${props.row.idhoja}`">{{ props.row.idhoja }}</q-btn>
                                                </q-td>
                                                <q-td  key="correo" :props="props">
                                                    {{ props.row.correo }}
                                                </q-td>
                                                <q-td  key="estcivil" :props="props">
                                                    {{ props.row.estcivil }}
                                                </q-td>
