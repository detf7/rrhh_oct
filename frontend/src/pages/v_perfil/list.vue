                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/v_perfil"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.VPerfilListHeaderItems" 
                                :rows="records"
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'v_perfillist',
		},
		apiPath : {
			type : String,
			default : 'v_perfil/index',
		},
		paginate: {
			type: Boolean,
			default: true,
