                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/compra/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/compra"></q-breadcrumbs-el>
                            ...
                            <div class="row q-col-gutter-x-md q-col-gutter-md justify-start">
                                <div class="col">
                                    ...
                                    <div >
                                        ...
                                        :bordered="false"
                                        :columns="app.menus.CompraListHeaderItems" 
                                        :rows="records"
                                        ...
                                        <template v-slot:body="props">
                                            <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                ...
                                                <q-td  key="codproveedor" :props="props">
                                                    <q-btn v-if="props.row.codproveedor" @click="app.openPageDialog({ page: 'proveedor/view', url: `/proveedor/view/${props.row.codproveedor}` , closeBtn: true })" padding="xs" flat color="primary" no-caps >
                                                        <q-icon name="visibility" size="xs"  class="q-mr-xs"></q-icon>  Proveedor
                                                    </q-btn>
                                                </q-td>
                                                ...
                                                <q-td  key="codalmacen" :props="props">
                                                    <q-btn v-if="props.row.codalmacen" @click="app.openPageDialog({ page: 'almacen/view', url: `/almacen/view/${props.row.codalmacen}` , closeBtn: true })" padding="xs" flat color="primary" no-caps >
                                                        <q-icon name="visibility" size="xs"  class="q-mr-xs"></q-icon>  Almacen
                                                    </q-btn>
                                                </q-td>
                                                ...
                                                <q-td  key="idcompra" :props="props">
                                                    <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/compra/view/${props.row.idcompra}`">{{ props.row.idcompra }}</q-btn>
                                                </q-td>
                                                <q-td  key="codcompra" :props="props">
                                                    <q-btn v-if="props.row.codcompra" @click="app.openPageDialog({ page: 'compra/view', url: `/compra/view/${props.row.codcompra}` , closeBtn: true })" padding="xs" flat color="primary" no-caps >
                                                        <q-icon name="visibility" size="xs"  class="q-mr-xs"></q-icon>  Compra
                                                    </q-btn>
                                                </q-td>
                                                        ...
                                                        <q-btn icon="menu" padding="xs" round flat color="grey">
                                                            <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                                <q-list dense rounded nav>
                                                                    <q-item link clickable v-ripple :to="`/compra/view/${props.row.idcompra}`">
                                                                        <q-item-section>
                                                                            <q-icon color="primary" size="sm" name="visibility"></q-icon>
                                                                        </q-item-section>
                                                                        <q-item-section>View</q-item-section>
                                                                    </q-item>
                                                                    <q-item link clickable v-ripple :to="`/compra/edit/${props.row.idcompra}`">
                                                                        <q-item-section>
                                                                            <q-icon color="positive" size="sm" name="edit"></q-icon>
                                                                        </q-item-section>
                                                                        <q-item-section>Edit</q-item-section>
                                                                    </q-item>
                                                                    <q-item link clickable v-ripple @click="deleteItem(props.row.idcompra)">
                                                                        <q-item-section>
