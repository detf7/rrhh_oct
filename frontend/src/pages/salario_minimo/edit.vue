                                    ...
                                    <div class="row q-col-gutter-x-md">
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <q-input   ref="ctrlimporte" v-model.trim="formData.importe"  label="Importe" type="text" placeholder="Escribir Importe"      
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <q-input   ref="ctrlrespaldo_leg" v-model.trim="formData.respaldo_leg"  label="Respaldo Leg" type="text" placeholder="Escribir Respaldo Leg"      
...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'salario_minimoedit',
		},
		pagePath: {
			type : String,
			default : 'salario_minimo/edit',
		},
		apiPath: {
			type: String,
			default: 'salario_minimo/edit',
