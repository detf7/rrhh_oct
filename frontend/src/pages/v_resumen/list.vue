                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/v_resumen"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.VResumenListHeaderItems" 
                                :rows="records"
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'v_resumenlist',
		},
		apiPath : {
			type : String,
			default : 'v_resumen/index',
		},
		paginate: {
			type: Boolean,
			default: true,
