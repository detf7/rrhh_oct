                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/temp_cas1/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/temp_cas1"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.TempCas1ListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                        ...
                                        <q-td  key="id_cas" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/temp_cas1/view/${props.row.id_cas}`">{{ props.row.id_cas }}</q-btn>
                                        </q-td>
                                        <q-td  key="anyos" :props="props">
                                            {{ props.row.anyos }}
                                        </q-td>
                                        ...
                                        <q-td  key="id_permanente" :props="props">
                                            <q-btn v-if="props.row.id_permanente" @click="app.openPageDialog({ page: 'temp_permanente1/view', url: `/temp_permanente1/view/${props.row.id_permanente}` , closeBtn: true })" padding="xs" flat color="primary" no-caps >
                                                <q-icon name="visibility" size="xs"  class="q-mr-xs"></q-icon>  Temp Permanente1
                                            </q-btn>
                                        </q-td>
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <q-item link clickable v-ripple :to="`/temp_cas1/view/${props.row.id_cas}`">
                                                                <q-item-section>
                                                                    <q-icon color="primary" size="sm" name="visibility"></q-icon>
                                                                </q-item-section>
                                                                <q-item-section>View</q-item-section>
                                                            </q-item>
                                                            <q-item link clickable v-ripple :to="`/temp_cas1/edit/${props.row.id_cas}`">
                                                                <q-item-section>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'temp_cas1list',
		},
		apiPath : {
			type : String,
			default : 'temp_cas1/index',
		},
		paginate: {
			type: Boolean,
			default: true,
