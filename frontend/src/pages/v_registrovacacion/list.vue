                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/v_registrovacacion"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.VRegistrovacacionListHeaderItems" 
                                :rows="records"
...
<script setup>
	...
	const props = defineProps({
		...
		pageName : {
			type : String,
			default : 'v_registrovacacion',
		},
		routeName : {
			type : String,
			default : 'v_registrovacacionlist',
		},
		apiPath : {
			type : String,
			default : 'v_registrovacacion/index',
		},
		paginate: {
			type: Boolean,
			default: true,
