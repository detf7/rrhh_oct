<template>
    <div id="master-detailpage">
        <q-tabs  inline-label v-model="selectedTab" active-color="primary" indicator-color="primary" align="left">
            <q-tab no-caps name="detvacacion" icon="extension" label="Regvacacion Detvacacion" />
        </q-tabs>
        <q-separator></q-separator>
        <q-tab-panels keep-alive v-model="selectedTab" animated>
            <q-tab-panel class="q-pa-none" name="detvacacion">
                <div class="reset-grid">
                    <list-detvacacion-page ref="detvacacionListPage"  field-name="detvacacion.codregvacacion" :field-value="masterRecord.idregvacacion" :show-header="false" isSubPage>
...
const app = useApp();
const store = usePageStore('regvacacion');
...
function setDetailPageFormData(){
	...
	detvacacionStore.setFormData({ codregvacacion:record?.idregvacacion });
}
