                                    ...
                                    <div class="row q-col-gutter-x-md">
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <q-input   ref="ctrldisponible" v-model.trim="formData.disponible"  label="Disponible" type="number" placeholder="Escribir Disponible"   step="0.1"    
                                                    class="" :error="isFieldValid('disponible')" :error-message="getFieldError('disponible')">
                                                    </q-input>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <q-input   ref="ctrlduodecima" v-model.trim="formData.duodecima"  label="Duodecima" type="text" placeholder="Escribir Duodecima"      
                                                    class="" :error="isFieldValid('duodecima')" :error-message="getFieldError('duodecima')">
                                                    </q-input>
                                                </div>
                                            </div>
                                        </div>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'regvacacionadd',
		},
		apiPath : {
			type : String,
			default : 'regvacacion/add',
		},
		submitButtonLabel: {
			type: String,
			default: "Guardar",
