                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/v_permisosvacaciongeneral"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.VPermisosvacaciongeneralListHeaderItems" 
                                :rows="records"
...
<script setup>
	...
	const props = defineProps({
		...
		pageName : {
			type : String,
			default : 'v_permisosvacaciongeneral',
		},
		routeName : {
			type : String,
			default : 'v_permisosvacaciongenerallist',
		},
		apiPath : {
			type : String,
			default : 'v_permisosvacaciongeneral/index',
		},
		paginate: {
			type: Boolean,
			default: true,
	...
	const pageTitle = computed({
		get: function () {
			return "V Permisosvacaciongeneral"
		}
	});
