                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/tmpsaldos/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/tmpsaldos"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.TmpsaldosListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                        ...
                                        <q-td  key="idtmpsal" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/tmpsaldos/view/${props.row.idtmpsal}`">{{ props.row.idtmpsal }}</q-btn>
                                        </q-td>
                                        ...
                                        <q-td  key="tinicial" :props="props">
                                            {{ props.row.tinicial }}
                                        </q-td>
                                        <q-td  key="compras" :props="props">
                                            {{ props.row.compras }}
                                        </q-td>
                                        <q-td  key="tcompras" :props="props">
                                            {{ props.row.tcompras }}
                                        </q-td>
                                        <q-td  key="pedidos" :props="props">
                                            {{ props.row.pedidos }}
                                        </q-td>
                                        <q-td  key="tpedidos" :props="props">
                                            {{ props.row.tpedidos }}
                                        </q-td>
                                        <q-td  key="final" :props="props">
                                            {{ props.row.final }}
                                        </q-td>
                                        <q-td  key="tfinal" :props="props">
                                            {{ props.row.tfinal }}
                                        </q-td>
                                        ...
                                        <q-td  key="codmaterial" :props="props">
                                            <q-btn v-if="props.row.codmaterial" @click="app.openPageDialog({ page: 'material/view', url: `/material/view/${props.row.codmaterial}` , closeBtn: true })" padding="xs" flat color="primary" no-caps >
                                                <q-icon name="visibility" size="xs"  class="q-mr-xs"></q-icon>  Material
                                            </q-btn>
                                        </q-td>
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <q-item link clickable v-ripple :to="`/tmpsaldos/view/${props.row.idtmpsal}`">
                                                                <q-item-section>
                                                                    <q-icon color="primary" size="sm" name="visibility"></q-icon>
                                                                </q-item-section>
                                                                <q-item-section>View</q-item-section>
                                                            </q-item>
                                                            <q-item link clickable v-ripple :to="`/tmpsaldos/edit/${props.row.idtmpsal}`">
                                                                <q-item-section>
                                                                    <q-icon color="positive" size="sm" name="edit"></q-icon>
                                                                </q-item-section>
                                                                <q-item-section>Edit</q-item-section>
                                                            </q-item>
                                                            <q-item link clickable v-ripple @click="deleteItem(props.row.idtmpsal)">
                                                                <q-item-section>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'tmpsaldoslist',
		},
		apiPath : {
			type : String,
			default : 'tmpsaldos/index',
		},
		paginate: {
			type: Boolean,
			default: true,
