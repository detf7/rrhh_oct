                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/v_repcompras"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.VRepcomprasListHeaderItems" 
                                :rows="records"
...
<script setup>
	...
	const props = defineProps({
		...
		pageName : {
			type : String,
			default : 'v_repcompras',
		},
		routeName : {
			type : String,
			default : 'v_repcompraslist',
		},
		apiPath : {
			type : String,
			default : 'v_repcompras/index',
		},
		paginate: {
			type: Boolean,
			default: true,
