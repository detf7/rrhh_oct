                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/v_gestion"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.VGestionListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                        ...
                                        <q-td  key="escala" :props="props">
                                            {{ props.row.escala }}
                                        </q-td>
                                        <q-td  key="poa" :props="props">
                                            {{ props.row.poa }}
                                        </q-td>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'v_gestionlist',
		},
		apiPath : {
			type : String,
			default : 'v_gestion/index',
		},
		paginate: {
			type: Boolean,
			default: true,
