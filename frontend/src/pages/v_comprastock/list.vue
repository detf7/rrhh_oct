                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/v_comprastock"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.VComprastockListHeaderItems" 
                                :rows="records"
...
<script setup>
	...
	const props = defineProps({
		...
		pageName : {
			type : String,
			default : 'v_comprastock',
		},
		routeName : {
			type : String,
			default : 'v_comprastocklist',
		},
		apiPath : {
			type : String,
			default : 'v_comprastock/index',
		},
		paginate: {
			type: Boolean,
			default: true,
