                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/v_migraboletax"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.VMigraboletaListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                        ...
                                        <q-td  key="hini" :props="props">
                                            {{ props.row.hini }}
                                        </q-td>
                                        <q-td  key="ffin" :props="props">
                                            {{ props.row.ffin }}
                                        </q-td>
                                        <q-td  key="hfin" :props="props">
                                            {{ props.row.hfin }}
                                        </q-td>
...
<script setup>
	...
	const props = defineProps({
		...
		pageName : {
			type : String,
			default : 'v_migraboletax',
		},
		routeName : {
			type : String,
			default : 'v_migraboletaxlist',
		},
		apiPath : {
			type : String,
			default : 'v_migraboletax/index',
		},
		paginate: {
			type: Boolean,
			default: true,
