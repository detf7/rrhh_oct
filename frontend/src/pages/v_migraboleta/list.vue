                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/v_migraboleta"></q-breadcrumbs-el>
...
<script setup>
	...
	const props = defineProps({
		...
		pageName : {
			type : String,
			default : 'v_migraboleta',
		},
		routeName : {
			type : String,
			default : 'v_migraboletalist',
		},
		apiPath : {
			type : String,
			default : 'v_migraboleta/index',
		},
		paginate: {
			type: Boolean,
			default: true,
