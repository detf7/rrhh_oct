                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/material/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/material"></q-breadcrumbs-el>
                            ...
                            <div class="row q-col-gutter-x-md q-col-gutter-md justify-start">
                                <div class="col">
                                    ...
                                    <div >
                                        ...
                                        :bordered="false"
                                        :columns="app.menus.MaterialListHeaderItems" 
                                        :rows="records"
                                        ...
                                        <template v-slot:body="props">
                                            <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                ...
                                                <q-td  key="codcategoria" :props="props">
                                                    <q-btn v-if="props.row.codcategoria" @click="app.openPageDialog({ page: 'categoria/view', url: `/categoria/view/${props.row.codcategoria}` , closeBtn: true })" padding="xs" flat color="primary" no-caps >
                                                        <q-icon name="visibility" size="xs"  class="q-mr-xs"></q-icon>  Categoria
                                                    </q-btn>
                                                </q-td>
                                                <q-td  key="codmedida" :props="props">
                                                    <q-btn v-if="props.row.codmedida" @click="app.openPageDialog({ page: 'medida/view', url: `/medida/view/${props.row.codmedida}` , closeBtn: true })" padding="xs" flat color="primary" no-caps >
                                                        <q-icon name="visibility" size="xs"  class="q-mr-xs"></q-icon>  Medida
                                                    </q-btn>
                                                </q-td>
                                                <q-td  key="idmaterial" :props="props">
                                                    <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/material/view/${props.row.idmaterial}`">{{ props.row.idmaterial }}</q-btn>
                                                </q-td>
                                                        ...
                                                        <q-btn icon="menu" padding="xs" round flat color="grey">
                                                            <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                                <q-list dense rounded nav>
                                                                    <q-item link clickable v-ripple :to="`/material/view/${props.row.idmaterial}`">
                                                                        <q-item-section>
                                                                            <q-icon color="primary" size="sm" name="visibility"></q-icon>
                                                                        </q-item-section>
                                                                        <q-item-section>View</q-item-section>
                                                                    </q-item>
                                                                    <q-item link clickable v-ripple :to="`/material/edit/${props.row.idmaterial}`">
                                                                        <q-item-section>
                                                                            <q-icon color="positive" size="sm" name="edit"></q-icon>
                                                                        </q-item-section>
                                                                        <q-item-section>Edit</q-item-section>
                                                                    </q-item>
                                                                    <q-item link clickable v-ripple @click="deleteItem(props.row.idmaterial)">
                                                                        <q-item-section>
