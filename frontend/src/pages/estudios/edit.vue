                                    ...
                                    <div class="row q-col-gutter-x-md">
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <q-input   ref="ctrlarea" v-model.trim="formData.area"  label="Area" type="text" placeholder="Escribir Area"      
                                                    class="" :error="isFieldValid('area')" :error-message="getFieldError('area')">
                                                    </q-input>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <q-input   ref="ctrlg_inicio" v-model.trim="formData.g_inicio"  label="G Inicio" type="text" placeholder="Escribir G Inicio"      
                                                    class="" :error="isFieldValid('g_inicio')" :error-message="getFieldError('g_inicio')">
                                                    </q-input>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <q-input   ref="ctrlg_fin" v-model.trim="formData.g_fin"  label="G Fin" type="text" placeholder="Escribir G Fin"      
                                                    class="" :error="isFieldValid('g_fin')" :error-message="getFieldError('g_fin')">
                                                    </q-input>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <q-input   ref="ctrltitulo" v-model.trim="formData.titulo"  label="Titulo" type="text" placeholder="Escribir Titulo"      
...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'estudiosedit',
		},
		pagePath: {
			type : String,
			default : 'estudios/edit',
		},
		apiPath: {
			type: String,
			default: 'estudios/edit',
