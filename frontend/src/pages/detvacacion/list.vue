                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/detvacacion/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/detvacacion"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.DetvacacionListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                        ...
                                        <q-td  key="iddetvac" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/detvacacion/view/${props.row.iddetvac}`">{{ props.row.iddetvac }}</q-btn>
                                        </q-td>
                                        <q-td  key="cantidad" :props="props">
                                            {{ props.row.cantidad }}
                                        </q-td>
                                        <q-td  key="codregvacacion" :props="props">
                                            <q-btn v-if="props.row.codregvacacion" @click="app.openPageDialog({ page: 'regvacacion/view', url: `/regvacacion/view/${props.row.codregvacacion}` , closeBtn: true })" padding="xs" flat color="primary" no-caps >
                                                <q-icon name="visibility" size="xs"  class="q-mr-xs"></q-icon>  Regvacacion
                                            </q-btn>
                                        </q-td>
                                        ...
                                        <q-td  key="codvacacion" :props="props">
                                            <q-btn v-if="props.row.codvacacion" @click="app.openPageDialog({ page: 'vacaciones/view', url: `/vacaciones/view/${props.row.codvacacion}` , closeBtn: true })" padding="xs" flat color="primary" no-caps >
                                                <q-icon name="visibility" size="xs"  class="q-mr-xs"></q-icon>  Vacaciones
                                            </q-btn>
                                        </q-td>
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <q-item link clickable v-ripple :to="`/detvacacion/view/${props.row.iddetvac}`">
                                                                <q-item-section>
                                                                    <q-icon color="primary" size="sm" name="visibility"></q-icon>
                                                                </q-item-section>
                                                                <q-item-section>View</q-item-section>
                                                            </q-item>
                                                            <q-item link clickable v-ripple :to="`/detvacacion/edit/${props.row.iddetvac}`">
                                                                <q-item-section>
                                                                    <q-icon color="positive" size="sm" name="edit"></q-icon>
                                                                </q-item-section>
                                                                <q-item-section>Edit</q-item-section>
                                                            </q-item>
                                                            <q-item link clickable v-ripple @click="deleteItem(props.row.iddetvac)">
                                                                <q-item-section>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'detvacacionlist',
		},
		apiPath : {
			type : String,
			default : 'detvacacion/index',
		},
		paginate: {
			type: Boolean,
			default: true,
