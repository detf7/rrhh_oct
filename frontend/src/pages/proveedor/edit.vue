                                    ...
                                    <div class="row q-col-gutter-x-md">
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <q-input   ref="ctrltelefono" v-model.trim="formData.telefono"  label="Telefono" type="number" placeholder="Escribir Telefono"   step="any"    
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <q-input   ref="ctrlnit" v-model.trim="formData.nit"  label="Nit" type="number" placeholder="Escribir Nit"   step="any"    
...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'proveedoredit',
		},
		pagePath: {
			type : String,
			default : 'proveedor/edit',
		},
		apiPath: {
			type: String,
			default: 'proveedor/edit',
