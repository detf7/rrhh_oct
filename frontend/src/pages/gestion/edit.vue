                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <q-input   ref="ctrlidgestion" v-model.trim="formData.idgestion"  label="Idgestion" type="text" placeholder="Escribir Idgestion"      
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    ...
                                                    <q-option-group  ref="ctrlhabilitado" v-model="formData.habilitado" :options="app.menus.habilitado2Items"   size="md" ></q-option-group>
                                                    </q-field>
                                                </div>
                                            </div>
                                        </div>
