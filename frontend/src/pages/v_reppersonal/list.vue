                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/v_reppersonal"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.VReppersonalListHeaderItems" 
                                :rows="records"
...
<script setup>
	...
	const props = defineProps({
		...
		pageName : {
			type : String,
			default : 'v_reppersonal',
		},
		routeName : {
			type : String,
			default : 'v_reppersonallist',
		},
		apiPath : {
			type : String,
			default : 'v_reppersonal/index',
		},
		paginate: {
			type: Boolean,
			default: true,
