                    ...
                    <div class="row justify-between items-center q-col-gutter-md">
                        <div  class="col col-md-auto " >
                            <div class=" text-h6 text-primary" >
                                V Resumenpermisosandvacaciones
                            </div>
                        </div>
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/v_resumenpermisosandvacaciones"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.VResumenpermisosandvacacionesListHeaderItems" 
                                :rows="records"
...
<script setup>
	...
	const props = defineProps({
		...
		pageName : {
			type : String,
			default : 'v_resumenpermisosandvacaciones',
		},
		routeName : {
			type : String,
			default : 'v_resumenpermisosandvacacioneslist',
		},
		apiPath : {
			type : String,
			default : 'v_resumenpermisosandvacaciones/index',
		},
		paginate: {
			type: Boolean,
			default: true,
	...
	const pageTitle = computed({
		get: function () {
			return "V Resumenpermisosandvacaciones"
		}
	});
