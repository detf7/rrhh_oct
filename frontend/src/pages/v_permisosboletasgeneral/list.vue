                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/v_permisosboletasgeneral"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.VBoletascondatosListHeaderItems" 
                                :rows="records"
...
<script setup>
	...
	const props = defineProps({
		...
		pageName : {
			type : String,
			default : 'v_permisosboletasgeneral',
		},
		routeName : {
			type : String,
			default : 'v_permisosboletasgenerallist',
		},
		apiPath : {
			type : String,
			default : 'v_permisosboletasgeneral/index',
		},
		paginate: {
			type: Boolean,
			default: true,
	...
	const pageTitle = computed({
		get: function () {
			return "V Permisosboletasgeneral"
		}
	});
