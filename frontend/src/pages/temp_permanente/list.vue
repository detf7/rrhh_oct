                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/temp_permanente/add`" class="" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/temp_permanente"></q-breadcrumbs-el>
                            ...
                            <div class="row q-col-gutter-x-md q-col-gutter-md justify-start">
                                <div class="col">
                                    ...
                                    <div >
                                        ...
                                        :bordered="false"
                                        :columns="app.menus.TempPermanenteListHeaderItems" 
                                        :rows="records"
                                        ...
                                        <template v-slot:body="props">
                                            <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                ...
                                                <q-td  key="id_permanente" :props="props">
                                                    <q-btn v-if="props.row.id_permanente" @click="app.openPageDialog({ page: 'temp_cas/list', url: `/temp_cas/index/temp_cas.id_permanente/${props.row.id_permanente}` , closeBtn: true, width: '50%' })" padding="xs" flat color="primary" no-caps >
                                                        <q-icon name="visibility" size="xs"  class="q-mr-xs"></q-icon>  Temp Cas
                                                    </q-btn>
                                                </q-td>
                                                <q-td  key="saldo_cas" :props="props">
                                                    {{ props.row.saldo_cas }}
                                                </q-td>
                                                        ...
                                                        <q-btn icon="menu" padding="xs" round flat color="grey">
                                                            <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                                <q-list dense rounded nav>
                                                                    <q-item link clickable v-ripple :to="`/temp_permanente/view/${props.row.id_permanente}`">
                                                                        <q-item-section>
                                                                            <q-icon color="primary" size="sm" name="visibility"></q-icon>
                                                                        </q-item-section>
                                                                        <q-item-section>View</q-item-section>
                                                                    </q-item>
                                                                    <q-item link clickable v-ripple :to="`/temp_permanente/edit/${props.row.id_permanente}`">
                                                                        <q-item-section>
                                                                            <q-icon color="positive" size="sm" name="edit"></q-icon>
                                                                        </q-item-section>
                                                                        <q-item-section>Edit</q-item-section>
                                                                    </q-item>
                                                                    <q-item link clickable v-ripple @click="deleteItem(props.row.id_permanente)">
                                                                        <q-item-section>
...
<script setup>
	...
	const props = defineProps({
		primaryKey : {
			type : String,
			default : 'id_permanente',
		},
		pageName : {
			type : String,
			default : 'temp_permanente',
		},
		routeName : {
			type : String,
			default : 'temp_permanentelist',
		},
		apiPath : {
			type : String,
			default : 'temp_permanente/index',
		},
		paginate: {
			type: Boolean,
			default: true,
