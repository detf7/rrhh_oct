                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/v_cantidaditem"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.VCantidaditemListHeaderItems" 
                                :rows="records"
...
<script setup>
	...
	const props = defineProps({
		...
		pageName : {
			type : String,
			default : 'v_cantidaditem',
		},
		routeName : {
			type : String,
			default : 'v_cantidaditemlist',
		},
		apiPath : {
			type : String,
			default : 'v_cantidaditem/index',
		},
		paginate: {
			type: Boolean,
			default: true,
