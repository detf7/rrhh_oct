                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/v_correspondencia"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.VCorrespondenciaListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                        ...
                                        <q-td  key="unidaddep1" :props="props">
                                            {{ props.row.unidaddep1 }}
                                        </q-td>
                                        <q-td  key="unidaddep2" :props="props">
                                            {{ props.row.unidaddep2 }}
                                        </q-td>
                                        <q-td  key="idcarnet" :props="props">
                                            {{ props.row.idcarnet }}
                                        </q-td>
                                        <q-td  key="entidaddep" :props="props">
                                            {{ props.row.entidaddep }}
                                        </q-td>
                                    </q-tr>
                                </template>
                                <!-- End of Table Layout-->
...
<script setup>
	...
	const props = defineProps({
		...
		pageName : {
			type : String,
			default : 'v_correspondencia',
		},
		routeName : {
			type : String,
			default : 'v_correspondencialist',
		},
		apiPath : {
			type : String,
			default : 'v_correspondencia/index',
		},
		paginate: {
			type: Boolean,
			default: true,
