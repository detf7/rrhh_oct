                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/v_stockalmacen"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.VStockalmacenListHeaderItems" 
                                :rows="records"
                                :binary-state-sort="true"
                                separator="horizontal"
                                :dense="true"
                                row-key="codcategoria" 
...
<script setup>
	...
	const props = defineProps({
		...
		pageName : {
			type : String,
			default : 'v_stockalmacen',
		},
		routeName : {
			type : String,
			default : 'v_stockalmacenlist',
		},
		apiPath : {
			type : String,
			default : 'v_stockalmacen/index',
		},
		paginate: {
			type: Boolean,
			default: true,
