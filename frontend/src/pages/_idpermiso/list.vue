                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/_idpermiso"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.IdpermisoListHeaderItems" 
                                :rows="records"
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : '_idpermisolist',
		},
		apiPath : {
			type : String,
			default : '_idpermiso/index',
		},
		paginate: {
			type: Boolean,
			default: true,
