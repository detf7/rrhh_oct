                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/v_escalaasignada"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.VEscalaasignadaListHeaderItems" 
                                :rows="records"
...
<script setup>
	...
	const props = defineProps({
		...
		pageName : {
			type : String,
			default : 'v_escalaasignada',
		},
		routeName : {
			type : String,
			default : 'v_escalaasignadalist',
		},
		apiPath : {
			type : String,
			default : 'v_escalaasignada/index',
		},
		paginate: {
			type: Boolean,
			default: true,
