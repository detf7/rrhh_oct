                            ...
                            <div >
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                ...
                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                        <q-list dense rounded nav>
                                                            <q-item link clickable v-ripple :to="`/nivel_escala/view/${props.row.id_nivel_esc}`">
                                                                <q-item-section>
                                                                    <q-icon color="primary" size="sm" name="visibility"></q-icon>
                                                                </q-item-section>
                                                                <q-item-section>View</q-item-section>
                                                            </q-item>
                                                            <q-item link clickable v-ripple :to="`/nivel_escala/edit/${props.row.id_nivel_esc}`">
                                                                <q-item-section>
                                        ...
                                        <q-td  key="id_nivel_esc" :props="props">
                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/nivel_escala/view/${props.row.id_nivel_esc}`">{{ props.row.id_nivel_esc }}</q-btn>
                                        </q-td>
                                        <q-td  key="valor_nivel" :props="props">
                                            {{ props.row.valor_nivel }}
                                        </q-td>
                                        <q-td  key="id_fk_denom" :props="props">
                                            {{ props.row.id_fk_denom }}
                                        </q-td>
