                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/v_cargopersonal"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.VCargopersonalListHeaderItems" 
                                :rows="records"
...
<script setup>
	...
	const props = defineProps({
		...
		pageName : {
			type : String,
			default : 'v_cargopersonal',
		},
		routeName : {
			type : String,
			default : 'v_cargopersonallist',
		},
		apiPath : {
			type : String,
			default : 'v_cargopersonal/index',
		},
		paginate: {
			type: Boolean,
			default: true,
