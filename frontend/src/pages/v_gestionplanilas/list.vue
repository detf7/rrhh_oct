                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/v_gestionplanilas"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.VGestionplanilasListHeaderItems" 
                                :rows="records"
...
<script setup>
	...
	const props = defineProps({
		...
		pageName : {
			type : String,
			default : 'v_gestionplanilas',
		},
		routeName : {
			type : String,
			default : 'v_gestionplanilaslist',
		},
		apiPath : {
			type : String,
			default : 'v_gestionplanilas/index',
		},
		paginate: {
			type: Boolean,
			default: true,
