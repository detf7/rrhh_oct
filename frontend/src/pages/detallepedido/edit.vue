                                    ...
                                    <div class="row q-col-gutter-x-md">
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <api-data-source @loaded="response => mapOptionField(response, 'codpedido')"  api-path="components_data/codpedido_option_list"  v-slot="req">
                                                        <q-select    :loading="req.loading"   ref="ctrlcodpedido" emit-value map-options  v-model="formData.codpedido" :options="req.response" label="Codpedido"  :error="isFieldValid('codpedido')" :error-message="getFieldError('codpedido')">
                                                        </q-select> 
                                                    </api-data-source>
                                                </div>
                                            </div>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'detallepedidoedit',
		},
		pagePath: {
			type : String,
			default : 'detallepedido/edit',
		},
		apiPath: {
			type: String,
			default: 'detallepedido/edit',
