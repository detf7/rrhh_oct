                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/v_ppresupuestaria"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.VDetitemescListHeaderItems" 
                                :rows="records"
                                ...
                                <template v-slot:body="props">
                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                        ...
                                        <q-td  key="org1" :props="props">
                                            {{ props.row.org1 }}
                                        </q-td>
                                        <q-td  key="org2" :props="props">
                                            {{ props.row.org2 }}
                                        </q-td>
...
<script setup>
	...
	const props = defineProps({
		...
		pageName : {
			type : String,
			default : 'v_ppresupuestaria',
		},
		routeName : {
			type : String,
			default : 'v_ppresupuestarialist',
		},
		apiPath : {
			type : String,
			default : 'v_ppresupuestaria/index',
		},
		paginate: {
			type: Boolean,
			default: true,
