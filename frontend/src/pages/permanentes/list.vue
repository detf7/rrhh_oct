                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/permanentes/add`" class="" >
            ...
            <div class="container-fluid">
                <div class="row q-col-gutter-x-md">
                    <div  class="col comp-grid" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/permanentes"></q-breadcrumbs-el>
                            ...
                            <div class="row q-col-gutter-x-md q-col-gutter-md justify-start">
                                <div class="col">
                                    ...
                                    <div >
                                        ...
                                        :bordered="false"
                                        :columns="app.menus.PermanentesListHeaderItems" 
                                        :rows="records"
                                        ...
                                        <template v-slot:body="props">
                                            <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                        ...
                                                        <q-btn icon="menu" padding="xs" round flat color="grey">
                                                            <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                                <q-list dense rounded nav>
                                                                    <q-item link clickable v-ripple :to="`/permanentes/view/${props.row.idpermanente}`">
                                                                        <q-item-section>
                                                                            <q-icon color="primary" size="sm" name="visibility"></q-icon>
                                                                        </q-item-section>
                                                                        <q-item-section>View</q-item-section>
                                                                    </q-item>
                                                                    <q-item link clickable v-ripple :to="`/permanentes/edit/${props.row.idpermanente}`">
                                                                        <q-item-section>
                                                                    ...
                                                                    <q-item link clickable v-ripple :to="`/cas/add`">
                                                                        <q-item-section>
                                                                            <q-icon color="primary" size="sm" ></q-icon>
                                                                        </q-item-section>
                                                                        <q-item-section>agregar cas</q-item-section>
                                                                    </q-item>
                                                                </q-list>
                                                            </q-menu>
                                                        </q-btn>
                                                ...
                                                <q-td  key="pagovac" :props="props">
                                                    <q-btn v-if="props.row.pagovac" :to="`/cas/index/cas.id_cas/${props.row.pagovac}`" padding="xs" flat color="primary" no-caps >
                                                        <q-icon name="visibility" size="xs"  class="q-mr-xs"></q-icon>  Cas
                                                    </q-btn>
                                                </q-td>
                                                ...
                                                <q-td  key="codpermanente" :props="props">
                                                    <q-btn v-if="props.row.codpermanente" @click="app.openPageDialog({ page: 'permanentes/view', url: `/permanentes/view/${props.row.codpermanente}` , closeBtn: true })" padding="xs" flat color="primary" no-caps >
                                                        <q-icon name="visibility" size="xs"  class="q-mr-xs"></q-icon>  Permanentes
                                                    </q-btn>
                                                </q-td>
                                                <q-td  key="idpermanente" :props="props">
                                                    <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/permanentes/view/${props.row.idpermanente}`">{{ props.row.idpermanente }}</q-btn>
                                                </q-td>
                                                ...
                                                <q-td  key="id_cas" :props="props">
                                                    <q-btn v-if="props.row.id_cas" :to="`/cas/view/${props.row.id_cas}`" padding="xs" flat color="primary" no-caps >
                                                        <q-icon name="visibility" size="xs"  class="q-mr-xs"></q-icon>  Cas
                                                    </q-btn>
                                                </q-td>
                                            </q-tr>
                        ...
                        <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   @click="app.openPageDialog({ page: 'cas/add', url: `/cas/add` , closeBtn: true  })"  class="" >
                            Button 
                        </q-btn>
                    </div>
                </div>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'permanenteslist',
		},
		apiPath : {
			type : String,
			default : 'permanentes/index',
		},
		paginate: {
			type: Boolean,
			default: true,
