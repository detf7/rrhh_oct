                                    ...
                                    <div class="row q-col-gutter-x-md">
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <q-input   ref="ctrlopciones" v-model.trim="formData.opciones"  label="Opciones" type="text" placeholder="Escribir Opciones"      
                                                    class="" :error="isFieldValid('opciones')" :error-message="getFieldError('opciones')">
                                                    </q-input>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <q-input   ref="ctrlcodpregunta" v-model.trim="formData.codpregunta"  label="Codpregunta" type="text" placeholder="Escribir Codpregunta"      
                                                    class="" :error="isFieldValid('codpregunta')" :error-message="getFieldError('codpregunta')">
                                                    </q-input>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <q-input   ref="ctrltipopregunta" v-model.trim="formData.tipopregunta"  label="Tipopregunta" type="text" placeholder="Escribir Tipopregunta"      
                                                    class="" :error="isFieldValid('tipopregunta')" :error-message="getFieldError('tipopregunta')">
                                                    </q-input>
                                                </div>
                                            </div>
                                        </div>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'preguntasedit',
		},
		pagePath: {
			type : String,
			default : 'preguntas/edit',
		},
		apiPath: {
			type: String,
			default: 'preguntas/edit',
