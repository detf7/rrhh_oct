                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag">
                                <q-breadcrumbs class="q-pa-md">
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/v_unidadboleta"></q-breadcrumbs-el>
                            ...
                            <div >
                                ...
                                :bordered="false"
                                :columns="app.menus.VUnidadboletaListHeaderItems" 
                                :rows="records"
...
<script setup>
	...
	const props = defineProps({
		...
		pageName : {
			type : String,
			default : 'v_unidadboleta',
		},
		routeName : {
			type : String,
			default : 'v_unidadboletalist',
		},
		apiPath : {
			type : String,
			default : 'v_unidadboleta/index',
		},
		paginate: {
			type: Boolean,
			default: true,
